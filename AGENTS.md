...
| Directory | Purpose |
|-----------|---------|
| `agents/` | Agent definitions (multi-step orchestrators using Codex Agent SDK) |
| `commands/` | Slash-command definitions for Codex sessions |
...
| `skill-packages/` | Pre-built `.skill` ZIP archives for Codex web app upload |
